...
lib_tech = Company.create!(name: "Lib Tech", based_in_co: false, year_founded: 1977)
...
never_summer.snowboards.create!(name: "Gunslinger", powder_board: false, length: 157, company_id: never_summer)
